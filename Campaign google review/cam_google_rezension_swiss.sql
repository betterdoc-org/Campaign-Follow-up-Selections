...
with case_cube as (
	...
	where 
		--result_date between '2025-09-01' and '2025-11-30'
		result_date >= current_date - interval '6 month'
		and payer_group in ('kv')
...
final as (
	...
	where
		...
		and pii_case_cube.email != '' 
		and pii_case_cube.domain in ('@gmail.com','@googlemail.com')
	order by case_cube.case_id, case_cube.dna_patient_id, case_cube.result_date DESC
),
