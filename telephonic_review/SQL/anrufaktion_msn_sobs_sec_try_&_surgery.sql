...
md_campaigns_with_multiple_selections as (
select 
 case_id,
 count(*)
 from 
...
where
	...
	(1 = 1)
	--hard filters
	and product_v2 ilike '%msn%'
	AND prem_result_return_bool IS false
...
select
	...
	'ZF BKK' as cam_name, -----------------------------------------ACHTUNG hier Namen anpassen!!!
	'extra call campaign for our follow ups - ZF BKK' as cam_description, ------------ACHTUNG hier Namen anpassen!!!
